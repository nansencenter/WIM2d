...
function [Sdir,out_fields] = run_WIM2d_io_mex_vSdir(ice_fields,Sdir,wave_fields,int_prams,real_prams);
...
[nx,ny]     = size(ice_fields.cice);
Nin         = length(vnames);
in_arrays   = zeros(nx,ny,Nin);

for j=1:Nin
   cj = num2str(j);
   eval(['in_arrays(:,:,',cj,') = ',vnames{j},';']);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
disp('Calling mex function WIM2d_run_io_mex_vSdir...')

tic;
%     [Sdir_io,out_arrays]=...
%        WIM2d_run_io_mex_vSdir(Sdir_io,ice_arrays,real_prams,...
%                               int_prams,Tp_io,mwd_io);

[Sdir2,out_arrays]  = WIM2d_run_io_mex_v2(Sdir(:),in_arrays(:),int_prams,real_prams);
Sdir(:)              = Sdir2;
toc;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% outputs from mex function:
