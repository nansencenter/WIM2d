...
namespace WIMOPT
{
    ...
    descrOptions()
    {
        ...
        desc.add_options()
            ...
            ("scatmod", po::value<std::string>()->default_value( "dissipated" ), "Scattered energy is dissipated (=dissipated), distributed isotropically (=isotropic)")
            ...
            ("nz", po::value<int>()->default_value( 1000 ), "Record length in x direction")
            ...
            ("tmin", po::value<double>()->default_value( 2.5 ), "")
            ("tmax", po::value<double>()->default_value( 25. ), "")
            ...
            ("dfloepackthresh", po::value<double>()->default_value( 400. ), "")
            ("outparentdir", po::value<std::string>()->default_value( "." ), "Parent directory for the output files")
            ("dfloemin", po::value<double>()->default_value( 20. ), "")
            ("cicemin", po::value<double>()->default_value( 0.05 ), "")
            ("exportresults", po::value<bool>()->default_value( false ), "export results")
            ("nfloesgridtomesh", po::value<bool>()->default_value( true ), "")
            ("couplingfreq", po::value<int>()->default_value( 20 ), "")
            ;
        return desc;
    }
